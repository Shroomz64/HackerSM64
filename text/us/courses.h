COURSE_ACTS(COURSE_BOB, _("   Dream Gardens"),
       _("WHERE THE FUCK ARE WE!!")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _("   Fruit Castle"),
       _("OH BANANA")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_CCM, _("   Thank you for playing!"),
       _("Mod by Cyboo and Shroomz")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
COURSE_ACTS(COURSE_HMC, _("    Crystal Caves"),
       _("I HATE SPIDERS")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD MARIO CAN MOVE!"),
