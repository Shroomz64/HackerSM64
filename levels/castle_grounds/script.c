...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_NONE, -85, -3330, 3674, 0, -180, 0, (2 << 16), bhvAirborneWarp),
		MARIO_POS(1, -180, -80, -3341, 3706),
		OBJECT(MODEL_NONE, 57, 0, -1924, 0, 0, 0, (1 << 16), bhvBirdsSoundLoop),
		OBJECT(MODEL_NONE, 1574, -916, 1368, 0, 0, 0, (241 << 16), bhvDeathWarp),
		OBJECT(MODEL_WOODEN_SIGNPOST, 205, -3402, 3308, 0, -25, 0, (15 << 16), bhvSignOnWall),
	...
	AREA(2, castle_grounds_area_2),
		...
		WARP_NODE(241, LEVEL_BOB, 2, 6, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 514, 561, 2703, 0, 0, 0, (241 << 16), bhvDeathWarp),
