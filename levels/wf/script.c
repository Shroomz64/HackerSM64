...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		WARP_NODE(16, LEVEL_HMC, 1, 17, WARP_NO_CHECKPOINT),
		WARP_NODE(241, LEVEL_WF, 1, 15, WARP_NO_CHECKPOINT),
		WARP_NODE(15, LEVEL_WF, 1, 15, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -1506, 907, -708, 0, 0, 0, (241 << 16), bhvDeathWarp),
		OBJECT(MODEL_THWOMP, 220, 1741, -7304, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_THWOMP, 220, 1741, -9239, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_THWOMP, 220, 1741, -4411, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_WHOMP, -1948, 1707, -5826, 0, 90, 0, 0x00000000, bhvSmallWhomp),
		OBJECT(MODEL_WHOMP, -1429, 2228, -20704, 0, 90, 0, 0x00000000, bhvSmallWhomp),
		OBJECT(MODEL_THWOMP, -231, 1143, -19124, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_THWOMP, 778, 1697, -19113, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_THWOMP, 1852, 2292, -18985, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_THWOMP, 2792, 1012, -592, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_NONE, -2070, 2194, -20723, 0, 0, 0, (16 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -7, 415, -322, 0, 0, 0, (15 << 16), bhvAirborneWarp),
